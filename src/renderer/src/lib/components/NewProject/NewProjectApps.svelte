...
{#if store.flow === "DIY"}
  <div
    ...
    class="border-r border-white/5 absolute top-0 h-full left-0 overflow-auto flex flex-col items-center gap-[20px] pt-[22px]"
  >
    <div class="text-white/30 mb-[42px]">New project</div>
